            ...
            <form action="includes/genleasefile.inc.php" method="post">
                <div class="form-double">
                    ...
                    <div class="form-two-thirds">
                        ...
                        <input class="form-large" type="text" name="ownerAdd" value="                                         " placeholder="Owner Address">
                    </div>
                </div>
                <div class="form-double">
                    <div class="form-one-third">
                    ...
                    <div class="form-two-thirds">
                        <label> New Lease Address</label>
                        <input class="form-large" type="text" name="address" placeholder="Address" value="                                         ">
                    </div>
                </div>
                <div class="form-double">
                    <div class="form-one-half">
